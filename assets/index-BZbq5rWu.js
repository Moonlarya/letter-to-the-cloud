(function(){const d=document.createElement("link").relList;if(d&&d.supports&&d.supports("modulepreload"))return;for(const M of document.querySelectorAll('link[rel="modulepreload"]'))f(M);new MutationObserver(M=>{for(const C of M)if(C.type==="childList")for(const G of C.addedNodes)G.tagName==="LINK"&&G.rel==="modulepreload"&&f(G)}).observe(document,{childList:!0,subtree:!0});function p(M){const C={};return M.integrity&&(C.integrity=M.integrity),M.referrerPolicy&&(C.referrerPolicy=M.referrerPolicy),M.crossOrigin==="use-credentials"?C.credentials="include":M.crossOrigin==="anonymous"?C.credentials="omit":C.credentials="same-origin",C}function f(M){if(M.ep)return;M.ep=!0;const C=p(M);fetch(M.href,C)}})();function qh(c){return c&&c.__esModule&&Object.prototype.hasOwnProperty.call(c,"default")?c.default:c}var pu={exports:{}},Di={};/**
 * @license React
 ...
 */var bh;function rp(){if(bh)return Di;bh=1;var c=Symbol.for("react.transitional.element"),d=Symbol.for("react.fragment");function p(f,M,C){var G=null;if(C!==void 0&&(G=""+C),M.key!==void 0&&(G=""+M.key),"key"in M){C={};for(var X in M)X!=="key"&&(C[X]=M[X])}else C=M;return M=C.ref,{$$typeof:c,type:f,key:G,ref:M!==void 0?M:null,props:C}}return Di.Fragment=d,Di.jsx=p,Di.jsxs=p,Di}var vh;function up(){return vh||(vh=1,pu.exports=rp()),pu.exports}var Mt=up(),gu={exports:{}},ot={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Sh;function cp(){return Sh||(Sh=1,function(c){function d(z,j){var nt=z.length;z.push(j);t:for(;0<nt;){var Tt=nt-1>>>1,m=z[Tt];if(0<M(m,j))z[Tt]=j,z[nt]=m,nt=Tt;else break t}}function p(z){return z.length===0?null:z[0]}function f(z){if(z.length===0)return null;var j=z[0],nt=z.pop();if(nt!==j){z[0]=nt;t:for(var Tt=0,m=z.length,U=m>>>1;Tt<U;){var P=2*(Tt+1)-1,L=z[P],F=P+1,ht=z[F];if(0>M(L,nt))F<m&&0>M(ht,L)?(z[Tt]=ht,z[F]=nt,Tt=F):(z[Tt]=L,z[P]=nt,Tt=P);else if(F<m&&0>M(ht,nt))z[Tt]=ht,z[F]=nt,Tt=F;else break t}}return j}function M(z,j){var nt=z.sortIndex-j.sortIndex;return nt!==0?nt:z.id-j.id}if(c.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var C=performance;c.unstable_now=function(){return C.now()}}else{var G=Date,X=G.now();c.unstable_now=function(){return G.now()-X}}var N=[],O=[],Y=1,W=null,at=3,St=!1,E=!1,y=!1,B=!1,V=typeof setTimeout=="function"?setTimeout:null,pt=typeof clearTimeout=="function"?clearTimeout:null,q=typeof setImmediate<"u"?setImmediate:null;function o(z){for(var j=p(O);j!==null;){if(j.callback===null)f(O);else if(j.startTime<=z)f(O),j.sortIndex=j.expirationTime,d(N,j);else break;j=p(O)}}function u(z){if(y=!1,o(z),!E)if(p(N)!==null)E=!0,g||(g=!0,lt());else{var j=p(O);j!==null&&Ct(u,j.startTime-z)}}var g=!1,A=-1,D=5,k=-1;function Q(){return B?!0:!(c.unstable_now()-k<D)}function $(){if(B=!1,g){var z=c.unstable_now();k=z;var j=!0;try{t:{E=!1,y&&(y=!1,pt(A),A=-1),St=!0;var nt=at;try{n:{for(o(z),W=p(N);W!==null&&!(W.expirationTime>z&&Q());){var Tt=W.callback;if(typeof Tt=="function"){W.callback=null,at=W.priorityLevel;var m=Tt(W.expirationTime<=z);if(z=c.unstable_now(),typeof m=="function"){W.callback=m,o(z),j=!0;break n}W===p(N)&&f(N),o(z)}else f(N);W=p(N)}if(W!==null)j=!0;else{var U=p(O);U!==null&&Ct(u,U.startTime-z),j=!1}}break t}finally{W=null,at=nt,St=!1}j=void 0}}finally{j?lt():g=!1}}}var lt;if(typeof q=="function")lt=function(){q($)};else if(typeof MessageChannel<"u"){var Et=new MessageChannel,Lt=Et.port2;Et.port1.onmessage=$,lt=function(){Lt.postMessage(null)}}else lt=function(){V($,0)};function Ct(z,j){A=V(function(){z(c.unstable_now())},j)}c.unstable_IdlePriority=5,c.unstable_ImmediatePriority=1,c.unstable_LowPriority=4,c.unstable_NormalPriority=3,c.unstable_Profiling=null,c.unstable_UserBlockingPriority=2,c.unstable_cancelCallback=function(z){z.callback=null},c.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<z?Math.floor(1e3/z):5},c.unstable_getCurrentPriorityLevel=function(){return at},c.unstable_next=function(z){switch(at){case 1:case 2:case 3:var j=3;break;default:j=at}var nt=at;at=j;try{return z()}finally{at=nt}},c.unstable_requestPaint=function(){B=!0},c.unstable_runWithPriority=function(z,j){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var nt=at;at=z;try{return j()}finally{at=nt}},c.unstable_scheduleCallback=function(z,j,nt){var Tt=c.unstable_now();switch(typeof nt=="object"&&nt!==null?(nt=nt.delay,nt=typeof nt=="number"&&0<nt?Tt+nt:Tt):nt=Tt,z){case 1:var m=-1;break;case 2:m=250;break;case 5:m=1073741823;break;case 4:m=1e4;break;default:m=5e3}return m=nt+m,z={id:Y++,callback:j,priorityLevel:z,startTime:nt,expirationTime:m,sortIndex:-1},nt>Tt?(z.sortIndex=nt,d(O,z),p(N)===null&&z===p(O)&&(y?(pt(A),A=-1):y=!0,Ct(u,nt-Tt))):(z.sortIndex=m,d(N,z),E||St||(E=!0,g||(g=!0,lt()))),z},c.unstable_shouldYield=Q,c.unstable_wrapCallback=function(z){var j=at;return function(){var nt=at;at=j;try{return z.apply(this,arguments)}finally{at=nt}}}}(vu)),vu}var Th;function fp(){return Th||(Th=1,bu.exports=cp()),bu.exports}var yu={exports:{}},Ft={};/**
 * @license React
...
`),S=s.split(`
`);for(i=a=0;a<h.length&&!h[a].includes("DetermineComponentFrameRoot");)a++;for(;i<S.length&&!S[i].includes("DetermineComponentFrameRoot");)i++;if(a===h.length||i===S.length)for(a=h.length-1,i=S.length-1;1<=a&&0<=i&&h[a]!==S[i];)i--;for(;1<=a&&0<=i;a--,i--)if(h[a]!==S[i]){if(a!==1||i!==1)do if(a--,i--,0>i||h[a]!==S[i]){var _=`
...
`,f})())}(Jl)),Jl.exports}var yp=vp();const xp=qh(yp);function Xt(c,d){d===void 0&&(d={});var p=d.insertAt;if(c&&typeof document<"u"){var f=document.head||document.getElementsByTagName("head")[0],M=document.createElement("style");M.type="text/css",p==="top"&&f.firstChild?f.insertBefore(M,f.firstChild):f.appendChild(M),M.styleSheet?M.styleSheet.cssText=c:M.appendChild(document.createTextNode(c))}}Xt(`.react-loading-indicator-normalize,
...
}`);var Bn=function(){return Bn=Object.assign||function(c){for(var d,p=1,f=arguments.length;p<f;p++)for(var M in d=arguments[p])Object.prototype.hasOwnProperty.call(d,M)&&(c[M]=d[M]);return c},Bn.apply(this,arguments)};function Wl(c){return Wl=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(d){return typeof d}:function(d){return d&&typeof Symbol=="function"&&d.constructor===Symbol&&d!==Symbol.prototype?"symbol":typeof d},Wl(c)}var Sp=/^\s+/,Tp=/\s+$/;function J(c,d){if(d=d||{},(c=c||"")instanceof J)return c;if(!(this instanceof J))return new J(c,d);var p=function(f){var M={r:0,g:0,b:0},C=1,G=null,X=null,N=null,O=!1,Y=!1;typeof f=="string"&&(f=function(E){E=E.replace(Sp,"").replace(Tp,"").toLowerCase();var y,B=!1;if(Tu[E])E=Tu[E],B=!0;else if(E=="transparent")return{r:0,g:0,b:0,a:0,format:"name"};return(y=zn.rgb.exec(E))?{r:y[1],g:y[2],b:y[3]}:(y=zn.rgba.exec(E))?{r:y[1],g:y[2],b:y[3],a:y[4]}:(y=zn.hsl.exec(E))?{h:y[1],s:y[2],l:y[3]}:(y=zn.hsla.exec(E))?{h:y[1],s:y[2],l:y[3],a:y[4]}:(y=zn.hsv.exec(E))?{h:y[1],s:y[2],v:y[3]}:(y=zn.hsva.exec(E))?{h:y[1],s:y[2],v:y[3],a:y[4]}:(y=zn.hex8.exec(E))?{r:bn(y[1]),g:bn(y[2]),b:bn(y[3]),a:Hh(y[4]),format:B?"name":"hex8"}:(y=zn.hex6.exec(E))?{r:bn(y[1]),g:bn(y[2]),b:bn(y[3]),format:B?"name":"hex"}:(y=zn.hex4.exec(E))?{r:bn(y[1]+""+y[1]),g:bn(y[2]+""+y[2]),b:bn(y[3]+""+y[3]),a:Hh(y[4]+""+y[4]),format:B?"name":"hex8"}:(y=zn.hex3.exec(E))?{r:bn(y[1]+""+y[1]),g:bn(y[2]+""+y[2]),b:bn(y[3]+""+y[3]),format:B?"name":"hex"}:!1}(f)),Wl(f)=="object"&&(te(f.r)&&te(f.g)&&te(f.b)?(W=f.r,at=f.g,St=f.b,M={r:255*zt(W,255),g:255*zt(at,255),b:255*zt(St,255)},O=!0,Y=String(f.r).substr(-1)==="%"?"prgb":"rgb"):te(f.h)&&te(f.s)&&te(f.v)?(G=zi(f.s),X=zi(f.v),M=function(E,y,B){E=6*zt(E,360),y=zt(y,100),B=zt(B,100);var V=Math.floor(E),pt=E-V,q=B*(1-y),o=B*(1-pt*y),u=B*(1-(1-pt)*y),g=V%6,A=[B,o,q,q,u,B][g],D=[u,B,B,o,q,q][g],k=[q,q,u,B,B,o][g];return{r:255*A,g:255*D,b:255*k}}(f.h,G,X),O=!0,Y="hsv"):te(f.h)&&te(f.s)&&te(f.l)&&(G=zi(f.s),N=zi(f.l),M=function(E,y,B){var V,pt,q;function o(A,D,k){return k<0&&(k+=1),k>1&&(k-=1),k<1/6?A+6*(D-A)*k:k<.5?D:k<2/3?A+(D-A)*(2/3-k)*6:A}if(E=zt(E,360),y=zt(y,100),B=zt(B,100),y===0)V=pt=q=B;else{var u=B<.5?B*(1+y):B+y-B*y,g=2*B-u;V=o(g,u,E+1/3),pt=o(g,u,E),q=o(g,u,E-1/3)}return{r:255*V,g:255*pt,b:255*q}}(f.h,G,N),O=!0,Y="hsl"),f.hasOwnProperty("a")&&(C=f.a));var W,at,St;return C=Uh(C),{ok:O,format:f.format||Y,r:Math.min(255,Math.max(M.r,0)),g:Math.min(255,Math.max(M.g,0)),b:Math.min(255,Math.max(M.b,0)),a:C}}(c);this._originalInput=c,this._r=p.r,this._g=p.g,this._b=p.b,this._a=p.a,this._roundA=Math.round(100*this._a)/100,this._format=d.format||p.format,this._gradientType=d.gradientType,this._r<1&&(this._r=Math.round(this._r)),this._g<1&&(this._g=Math.round(this._g)),this._b<1&&(this._b=Math.round(this._b)),this._ok=p.ok}function Dh(c,d,p){c=zt(c,255),d=zt(d,255),p=zt(p,255);var f,M,C=Math.max(c,d,p),G=Math.min(c,d,p),X=(C+G)/2;if(C==G)f=M=0;else{var N=C-G;switch(M=X>.5?N/(2-C-G):N/(C+G),C){case c:f=(d-p)/N+(d<p?6:0);break;case d:f=(p-c)/N+2;break;case p:f=(c-d)/N+4}f/=6}return{h:f,s:M,l:X}}function _h(c,d,p){c=zt(c,255),d=zt(d,255),p=zt(p,255);var f,M,C=Math.max(c,d,p),G=Math.min(c,d,p),X=C,N=C-G;if(M=C===0?0:N/C,C==G)f=0;else{switch(C){case c:f=(d-p)/N+(d<p?6:0);break;case d:f=(p-c)/N+2;break;case p:f=(c-d)/N+4}f/=6}return{h:f,s:M,v:X}}function zh(c,d,p,f){var M=[Rn(Math.round(c).toString(16)),Rn(Math.round(d).toString(16)),Rn(Math.round(p).toString(16))];return f&&M[0].charAt(0)==M[0].charAt(1)&&M[1].charAt(0)==M[1].charAt(1)&&M[2].charAt(0)==M[2].charAt(1)?M[0].charAt(0)+M[1].charAt(0)+M[2].charAt(0):M.join("")}function Rh(c,d,p,f){return[Rn(Nh(f)),Rn(Math.round(c).toString(16)),Rn(Math.round(d).toString(16)),Rn(Math.round(p).toString(16))].join("")}function Op(c,d){d=d===0?0:d||10;var p=J(c).toHsl();return p.s-=d/100,p.s=$l(p.s),J(p)}function wp(c,d){d=d===0?0:d||10;var p=J(c).toHsl();return p.s+=d/100,p.s=$l(p.s),J(p)}function Ap(c){return J(c).desaturate(100)}function Mp(c,d){d=d===0?0:d||10;var p=J(c).toHsl();return p.l+=d/100,p.l=$l(p.l),J(p)}function Ep(c,d){d=d===0?0:d||10;var p=J(c).toRgb();return p.r=Math.max(0,Math.min(255,p.r-Math.round(-d/100*255))),p.g=Math.max(0,Math.min(255,p.g-Math.round(-d/100*255))),p.b=Math.max(0,Math.min(255,p.b-Math.round(-d/100*255))),J(p)}function Dp(c,d){d=d===0?0:d||10;var p=J(c).toHsl();return p.l-=d/100,p.l=$l(p.l),J(p)}function _p(c,d){var p=J(c).toHsl(),f=(p.h+d)%360;return p.h=f<0?360+f:f,J(p)}function zp(c){var d=J(c).toHsl();return d.h=(d.h+180)%360,J(d)}function Ch(c,d){if(isNaN(d)||d<=0)throw new Error("Argument to polyad must be a positive number");for(var p=J(c).toHsl(),f=[J(c)],M=360/d,C=1;C<d;C++)f.push(J({h:(p.h+C*M)%360,s:p.s,l:p.l}));return f}function Rp(c){var d=J(c).toHsl(),p=d.h;return[J(c),J({h:(p+72)%360,s:d.s,l:d.l}),J({h:(p+216)%360,s:d.s,l:d.l})]}function Cp(c,d,p){d=d||6,p=p||30;var f=J(c).toHsl(),M=360/p,C=[J(c)];for(f.h=(f.h-(M*d>>1)+720)%360;--d;)f.h=(f.h+M)%360,C.push(J(f));return C}function Hp(c,d){d=d||6;for(var p=J(c).toHsv(),f=p.h,M=p.s,C=p.v,G=[],X=1/d;d--;)G.push(J({h:f,s:M,v:C})),C=(C+X)%1;return G}J.prototype={isDark:function(){return this.getBrightness()<128},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var c=this.toRgb();return(299*c.r+587*c.g+114*c.b)/1e3},getLuminance:function(){var c,d,p,f=this.toRgb();return c=f.r/255,d=f.g/255,p=f.b/255,.2126*(c<=.03928?c/12.92:Math.pow((c+.055)/1.055,2.4))+.7152*(d<=.03928?d/12.92:Math.pow((d+.055)/1.055,2.4))+.0722*(p<=.03928?p/12.92:Math.pow((p+.055)/1.055,2.4))},setAlpha:function(c){return this._a=Uh(c),this._roundA=Math.round(100*this._a)/100,this},toHsv:function(){var c=_h(this._r,this._g,this._b);return{h:360*c.h,s:c.s,v:c.v,a:this._a}},toHsvString:function(){var c=_h(this._r,this._g,this._b),d=Math.round(360*c.h),p=Math.round(100*c.s),f=Math.round(100*c.v);return this._a==1?"hsv("+d+", "+p+"%, "+f+"%)":"hsva("+d+", "+p+"%, "+f+"%, "+this._roundA+")"},toHsl:function(){var c=Dh(this._r,this._g,this._b);return{h:360*c.h,s:c.s,l:c.l,a:this._a}},toHslString:function(){var c=Dh(this._r,this._g,this._b),d=Math.round(360*c.h),p=Math.round(100*c.s),f=Math.round(100*c.l);return this._a==1?"hsl("+d+", "+p+"%, "+f+"%)":"hsla("+d+", "+p+"%, "+f+"%, "+this._roundA+")"},toHex:function(c){return zh(this._r,this._g,this._b,c)},toHexString:function(c){return"#"+this.toHex(c)},toHex8:function(c){return function(d,p,f,M,C){var G=[Rn(Math.round(d).toString(16)),Rn(Math.round(p).toString(16)),Rn(Math.round(f).toString(16)),Rn(Nh(M))];return C&&G[0].charAt(0)==G[0].charAt(1)&&G[1].charAt(0)==G[1].charAt(1)&&G[2].charAt(0)==G[2].charAt(1)&&G[3].charAt(0)==G[3].charAt(1)?G[0].charAt(0)+G[1].charAt(0)+G[2].charAt(0)+G[3].charAt(0):G.join("")}(this._r,this._g,this._b,this._a,c)},toHex8String:function(c){return"#"+this.toHex8(c)},toRgb:function(){return{r:Math.round(this._r),g:Math.round(this._g),b:Math.round(this._b),a:this._a}},toRgbString:function(){return this._a==1?"rgb("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+")":"rgba("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+", "+this._roundA+")"},toPercentageRgb:function(){return{r:Math.round(100*zt(this._r,255))+"%",g:Math.round(100*zt(this._g,255))+"%",b:Math.round(100*zt(this._b,255))+"%",a:this._a}},toPercentageRgbString:function(){return this._a==1?"rgb("+Math.round(100*zt(this._r,255))+"%, "+Math.round(100*zt(this._g,255))+"%, "+Math.round(100*zt(this._b,255))+"%)":"rgba("+Math.round(100*zt(this._r,255))+"%, "+Math.round(100*zt(this._g,255))+"%, "+Math.round(100*zt(this._b,255))+"%, "+this._roundA+")"},toName:function(){return this._a===0?"transparent":!(this._a<1)&&(kp[zh(this._r,this._g,this._b,!0)]||!1)},toFilter:function(c){var d="#"+Rh(this._r,this._g,this._b,this._a),p=d,f=this._gradientType?"GradientType = 1, ":"";if(c){var M=J(c);p="#"+Rh(M._r,M._g,M._b,M._a)}return"progid:DXImageTransform.Microsoft.gradient("+f+"startColorstr="+d+",endColorstr="+p+")"},toString:function(c){var d=!!c;c=c||this._format;var p=!1,f=this._a<1&&this._a>=0;return d||!f||c!=="hex"&&c!=="hex6"&&c!=="hex3"&&c!=="hex4"&&c!=="hex8"&&c!=="name"?(c==="rgb"&&(p=this.toRgbString()),c==="prgb"&&(p=this.toPercentageRgbString()),c!=="hex"&&c!=="hex6"||(p=this.toHexString()),c==="hex3"&&(p=this.toHexString(!0)),c==="hex4"&&(p=this.toHex8String(!0)),c==="hex8"&&(p=this.toHex8String()),c==="name"&&(p=this.toName()),c==="hsl"&&(p=this.toHslString()),c==="hsv"&&(p=this.toHsvString()),p||this.toHexString()):c==="name"&&this._a===0?this.toName():this.toRgbString()},clone:function(){return J(this.toString())},_applyModification:function(c,d){var p=c.apply(null,[this].concat([].slice.call(d)));return this._r=p._r,this._g=p._g,this._b=p._b,this.setAlpha(p._a),this},lighten:function(){return this._applyModification(Mp,arguments)},brighten:function(){return this._applyModification(Ep,arguments)},darken:function(){return this._applyModification(Dp,arguments)},desaturate:function(){return this._applyModification(Op,arguments)},saturate:function(){return this._applyModification(wp,arguments)},greyscale:function(){return this._applyModification(Ap,arguments)},spin:function(){return this._applyModification(_p,arguments)},_applyCombination:function(c,d){return c.apply(null,[this].concat([].slice.call(d)))},analogous:function(){return this._applyCombination(Cp,arguments)},complement:function(){return this._applyCombination(zp,arguments)},monochromatic:function(){return this._applyCombination(Hp,arguments)},splitcomplement:function(){return this._applyCombination(Rp,arguments)},triad:function(){return this._applyCombination(Ch,[3])},tetrad:function(){return this._applyCombination(Ch,[4])}},J.fromRatio=function(c,d){if(Wl(c)=="object"){var p={};for(var f in c)c.hasOwnProperty(f)&&(p[f]=f==="a"?c[f]:zi(c[f]));c=p}return J(c,d)},J.equals=function(c,d){return!(!c||!d)&&J(c).toRgbString()==J(d).toRgbString()},J.random=function(){return J.fromRatio({r:Math.random(),g:Math.random(),b:Math.random()})},J.mix=function(c,d,p){p=p===0?0:p||50;var f=J(c).toRgb(),M=J(d).toRgb(),C=p/100;return J({r:(M.r-f.r)*C+f.r,g:(M.g-f.g)*C+f.g,b:(M.b-f.b)*C+f.b,a:(M.a-f.a)*C+f.a})},J.readability=function(c,d){var p=J(c),f=J(d);return(Math.max(p.getLuminance(),f.getLuminance())+.05)/(Math.min(p.getLuminance(),f.getLuminance())+.05)},J.isReadable=function(c,d,p){var f,M,C=J.readability(c,d);switch(M=!1,(f=function(G){var X,N;return X=((G=G||{level:"AA",size:"small"}).level||"AA").toUpperCase(),N=(G.size||"small").toLowerCase(),X!=="AA"&&X!=="AAA"&&(X="AA"),N!=="small"&&N!=="large"&&(N="small"),{level:X,size:N}}(p)).level+f.size){case"AAsmall":case"AAAlarge":M=C>=4.5;break;case"AAlarge":M=C>=3;break;case"AAAsmall":M=C>=7}return M},J.mostReadable=function(c,d,p){var f,M,C,G,X=null,N=0;M=(p=p||{}).includeFallbackColors,C=p.level,G=p.size;for(var O=0;O<d.length;O++)(f=J.readability(c,d[O]))>N&&(N=f,X=J(d[O]));return J.isReadable(c,X,{level:C,size:G})||!M?X:(p.includeFallbackColors=!1,J.mostReadable(c,["#fff","#000"],p))};var Tu=J.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},kp=J.hexNames=function(c){var d={};for(var p in c)c.hasOwnProperty(p)&&(d[c[p]]=p);return d}(Tu);function Uh(c){return c=parseFloat(c),(isNaN(c)||c<0||c>1)&&(c=1),c}function zt(c,d){(function(f){return typeof f=="string"&&f.indexOf(".")!=-1&&parseFloat(f)===1})(c)&&(c="100%");var p=function(f){return typeof f=="string"&&f.indexOf("%")!=-1}(c);return c=Math.min(d,Math.max(0,parseFloat(c))),p&&(c=parseInt(c*d,10)/100),Math.abs(c-d)<1e-6?1:c%d/parseFloat(d)}function $l(c){return Math.min(1,Math.max(0,c))}function bn(c){return parseInt(c,16)}function Rn(c){return c.length==1?"0"+c:""+c}function zi(c){return c<=1&&(c=100*c+"%"),c}function Nh(c){return Math.round(255*parseFloat(c)).toString(16)}function Hh(c){return bn(c)/255}var Me,Vl,Kl,zn=(Vl="[\\s|\\(]+("+(Me="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)")+")[,|\\s]+("+Me+")[,|\\s]+("+Me+")\\s*\\)?",Kl="[\\s|\\(]+("+Me+")[,|\\s]+("+Me+")[,|\\s]+("+Me+")[,|\\s]+("+Me+")\\s*\\)?",{CSS_UNIT:new RegExp(Me),rgb:new RegExp("rgb"+Vl),rgba:new RegExp("rgba"+Kl),hsl:new RegExp("hsl"+Vl),hsla:new RegExp("hsla"+Kl),hsv:new RegExp("hsv"+Vl),hsva:new RegExp("hsva"+Kl),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/});function te(c){return!!zn.CSS_UNIT.exec(c)}var qp=function(c,d){var p=(typeof c=="string"?parseInt(c):c)||0;if(p>=-5&&p<=5){var f=p,M=parseFloat(d),C=M+f*(M/5)*-1;return(C==0||C<=Number.EPSILON)&&(C=.1),{animationPeriod:C+"s"}}return{animationPeriod:d}},Up=function(c,d){var p=c||{},f="";switch(d){case"small":f="12px";break;case"medium":f="16px";break;case"large":f="20px";break;default:f=void 0}var M={};if(p.fontSize){var C=p.fontSize;M=function(G,X){var N={};for(var O in G)Object.prototype.hasOwnProperty.call(G,O)&&X.indexOf(O)<0&&(N[O]=G[O]);if(G!=null&&typeof Object.getOwnPropertySymbols=="function"){var Y=0;for(O=Object.getOwnPropertySymbols(G);Y<O.length;Y++)X.indexOf(O[Y])<0&&Object.prototype.propertyIsEnumerable.call(G,O[Y])&&(N[O[Y]]=G[O[Y]])}return N}(p,["fontSize"]),f=C}return{fontSize:f,styles:M}},Np={color:"currentColor",mixBlendMode:"difference",width:"unset",display:"block",paddingTop:"2px"},Bp=function(c){var d=c.className,p=c.text,f=c.textColor,M=c.staticText,C=c.style;return p?tn.createElement("span",{className:"rli-d-i-b rli-text-format ".concat(d||"").trim(),style:Bn(Bn(Bn({},M&&Np),f&&{color:f,mixBlendMode:"unset"}),C&&C)},typeof p=="string"&&p.length?p:"loading"):null},Bh="rgb(50, 205, 50)";function Yp(c,d){if(d===void 0&&(d=0),c.length===0)throw new Error("Input array cannot be empty!");var p=[];return function f(M,C){return C===void 0&&(C=0),p.push.apply(p,M),p.length<C&&f(p,C),p.slice(0,C)}(c,d)}Xt(`.atom-rli-bounding-box {
...
}`);J(Bh).toRgb();Array.from({length:4},function(c,d){return"--atom-phase".concat(d+1,"-rgb")});Xt(`.commet-rli-bounding-box {
...
}`);var za=Array.from({length:4},function(c,d){return"--commet-phase".concat(d+1,"-color")}),Gp=function(c){var d,p=Up(c?.style,c?.size),f=p.styles,M=p.fontSize,C=c?.easing,G=qp(c?.speedPlus,"1.2s").animationPeriod,X=function(N){var O={};if(N instanceof Array){for(var Y=Yp(N,za.length),W=0;W<Y.length&&!(W>=4);W++)O[za[W]]=Y[W];return O}try{if(typeof N!="string")throw new Error("Color String expected");for(var at=0;at<za.length;at++)O[za[at]]=N}catch(St){for(St instanceof Error?console.warn("[".concat(St.message,']: Received "').concat(typeof N,'" instead with value, ').concat(JSON.stringify(N))):console.warn("".concat(JSON.stringify(N)," received in <Commet /> indicator cannot be processed. Using default instead!")),at=0;at<za.length;at++)O[za[at]]=Bh}return O}((d=c?.color)!==null&&d!==void 0?d:"");return tn.createElement("span",{className:"rli-d-i-b commet-rli-bounding-box",style:Bn(Bn(Bn(Bn(Bn({},M&&{fontSize:M}),G&&{"--rli-animation-duration":G}),C&&{"--rli-animation-function":C}),X),f),role:"status","aria-live":"polite","aria-label":"Loading"},tn.createElement("span",{className:"rli-d-i-b commet-indicator"},tn.createElement("span",{className:"rli-d-i-b commet-box"},tn.createElement("span",{className:"rli-d-i-b commet-trail trail1"}),tn.createElement("span",{className:"rli-d-i-b  commetball-box"})),tn.createElement("span",{className:"rli-d-i-b commet-box"},tn.createElement("span",{className:"rli-d-i-b commet-trail trail2"}),tn.createElement("span",{className:"rli-d-i-b commetball-box"})),tn.createElement(Bp,{className:"commet-text",text:c?.text,textColor:c?.textColor})))};Xt(`.OP-annulus-rli-bounding-box {
